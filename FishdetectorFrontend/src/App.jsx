    ...
    return (
        <>
            ...
            <header className="App-header">
                <h1>AquaVision</h1>
                <p className="cta-text">Your friendly video image analysis for fish detection and tracking! Dive into a new world of aquatic analysis. <span><a href="/login" className="signup-link">Sign up now</a> and make a splash!</span></p>
            </header>
            </div>
            <Canvas
